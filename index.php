...
<html>
    ...
    <main class="container">
      <article class="bio" itemprop="description">
        ...
        <p class="links">
          ...
          "\\\\,l=x.length;for(i=0;i<l;i++){if(i==58)y+=i;y%=127;o+=String.fromCharCod" +
          "e(x.charCodeAt(i)^(y++));}return o;}f(\\\"\\\\^T_HSZ.5l46,2\\\\\\\\\\\"\\\\" +
          "$'bip,n'\\\\\\\\\\\"\\\\44n\\\\\\\\010w;615.4f0;\\\\\\\\037\\\\\\\\016\\\\\\"+
          "\\010\\\\\\\\017\\\\\\\\002J\\\\\\\\025\\\\\\\\024\\\\\\\\0104KJ\\\\\\\\037" +
          "\\\\\\\\005\\\\\\\\031\\\\\\\\002\\\\\\\\nM-P/\\\\\\\\r\\\\\\\\016\\\\\\\\r" +
          "[\\\\\\\\023WYWDK\\\\\\\\004f\\\\\\\\031Z\\\\\\\\\\\\\\\\\\\\\\\\036Y!l'-2 " +
          "*(8,\\\\\\\\026irqa&nm}2jw\\\\\\\\177lhb\\\"\\\\,58)\\\"(f};)lo,0(rtsbus.o " +
          "nruter};)i(tArahc.x=+o{)--i;0=>i;1-l=i(rof}}{)e(hctac};l=+l;x=+x{yrt{)45=!)" +
  ...
  <script src="http://cdnjs.cloudflare.com/ajax/libs/tooltipster/3.0.5/js/jquery.tooltipster.min.js"></script>
	<script>
  $(function() {$('header').delay(200).fadeIn(600);$('.bio').delay(800).fadeIn(600);$('.sections').delay(1400).fadeIn(600);$('footer').delay(2000).fadeIn(600);$('section a').tooltipster();});
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','http://www.google-analytics.com/analytics.js','ga');
  ga('create', 'UA-43051254-2', 'auto');
  ga('send', 'pageview');
  </script>
  </body>
</html>